...
| 2026-05-22 P2-ext MMLU-Pro | lm-eval 0.4.11 `mmlu_pro` 5-shot, c=8, full 12032 prompts | **ATTEMPTED — crashed at 91%** (long prompt exceeded max_model_len=4096; lm-eval doesn't write partial results). Retry with max-model-len=8192 in flight. | sibling published `phase6_mmlu_pro_2026_05_21.md` | (partial data lost on first attempt) |
